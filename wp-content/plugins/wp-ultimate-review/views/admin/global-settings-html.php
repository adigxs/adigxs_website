...
<div id="xs_settings" class="wur-login-main-wrapper">
    ...
    <div class="wur-main-header">
        <h1>
            ...
            <?php echo esc_html__('WP Review Settings', 'wp-ultimate-review'); ?>
        </h1>
    </div>
