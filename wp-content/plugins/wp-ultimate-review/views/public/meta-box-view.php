...
if($viewRattingPage == 'Yes'):
    ...
    <form action="<?php echo esc_url(get_permalink($post->ID)); ?>" name="xs_review_form_public_data" method="post"
        ...
        <div class="xs-review-box public-xs-review-box" id="xs-review-box">
			...
			<?php
			if(isset($_COOKIE['xs_review_message']) AND strlen(sanitize_text_field(wp_unslash($_COOKIE['xs_review_message']))) > 4 && isset($_POST['xs_review_form_public_data'])){ //phpcs:ignore  (WordPress.Security.NonceVerification.Missing
			?>
            <div class="review_message_show">
                <p><?php echo esc_html__(sanitize_text_field(wp_unslash($_COOKIE['xs_review_message'])), 'wp-ultimate-review');
            ...
            <div class="wur-review-fields">
				...
				<?php if(isset($_COOKIE['xs_review_message']) AND strlen(sanitize_text_field(wp_unslash($_COOKIE['xs_review_message']))) > 4 && isset($_POST['xs_review_form_public_data']) && wp_verify_nonce('_wpnonce')) : ?>
            </div>
		<?php endif; ?>
        </div>
    </form>
